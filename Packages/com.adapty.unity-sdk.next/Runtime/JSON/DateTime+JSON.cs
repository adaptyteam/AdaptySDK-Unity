...
namespace AdaptySDK.SimpleJSON
{
    ...
    {
        internal static JSONNode ToJSONNode(this DateTime value)
        {
        ...
        internal static DateTime GetDateTime(this JSONNode node, string aKey) =>
            node.GetString(aKey).ToDateTime();
