...
namespace AdaptySDK.SimpleJSON
{
    ...
    {
        private static JSONNode GetJSONNodeIfPresent(this JSONNode node)
        {
        ...
        private static JSONNode GetJSONNode(this JSONNode node)
        {
            if (node is null) throw new Exception("JSON node is Null");
            return node;
        }
        ...
        internal static string GetString(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNode(node);
            if (!valueNode.IsString) throw new Exception($"Value is not String");
        ...
        internal static string GetStringIfPresent(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNodeIfPresent(node);
        ...
        internal static IList<string> GetStringListIfPresent(this JSONNode node)
        {
        ...
        internal static double GetDouble(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNode(node);
            if (!valueNode.IsNumber) throw new Exception($"Value is not Number");
        ...
        internal static double? GetDoubleIfPresent(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNodeIfPresent(node);
            if (valueNode is null) return null;
            if (!valueNode.IsNumber) throw new Exception($"Value is not Number");
        ...
        internal static int GetInteger(this JSONNode node) => (int)node.GetDouble();
        ...
        internal static long? GetLongIfPresent(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNodeIfPresent(node);
            if (valueNode is null) return null;
            if (!valueNode.IsNumber) throw new Exception($"Value is not Number");
        ...
        internal static bool GetBoolean(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNode(node);
            if (!valueNode.IsBoolean) throw new Exception($"Value is not Bool");
        ...
        internal static bool? GetBooleanIfPresent(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNodeIfPresent(node);
            if (valueNode is null) return null;
            if (!valueNode.IsBoolean) throw new Exception($"Value  is not Bool");
        ...
        internal static JSONArray GetArray(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNode(node);
            if (!valueNode.IsArray) throw new Exception($"Value is not Array");
        ...
        internal static JSONArray GetArrayIfPresent(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNodeIfPresent(node);
            if (valueNode is null) return null;
            if (!valueNode.IsArray) throw new Exception($"Value is not Array");
        ...
        internal static JSONObject GetObject(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNode(node);
            if (!valueNode.IsObject) throw new Exception($"Value is not Object");
        ...
        internal static JSONObject GetObjectIfPresent(this JSONNode node)
        {
            JSONNode valueNode = GetJSONNodeIfPresent(node);
            if (valueNode is null) return null;
            if (!valueNode.IsObject) throw new Exception($"Value is not Object");
