...
public class ActionsSection : MonoBehaviour
{
    ...
    public void RestorePurchasesPressed()
    {
        ...
        this.Listener.RestorePurchases(
            (error) =>
            {
    ...
    {
        this.Router.SetIsLoading(true);
        this.Listener.UpdateAppStoreCollectingRefundDataConsent(
            value,
            (error) =>
            {
                this.Router.SetIsLoading(false);
    ...
    {
        this.Router.SetIsLoading(true);
        this.Listener.UpdateAppStoreRefundPreference(
            value,
            (error) =>
            {
                this.Router.SetIsLoading(false);
    ...
    {
        this.Router.SetIsLoading(true);
        this.Listener.SetIntegrationIdentifier(
            (error) =>
            {
                this.Router.SetIsLoading(false);
            }
