...
namespace AdaptySDK.Noop
{
    internal static class AdaptyNoop
    {
        ...
        internal static void GetPaywall(string placementId, string locale, string fetchPolicy, Int64? timeoutInMillisecond, Action<string> completionHandler) { completionHandler(null); }
