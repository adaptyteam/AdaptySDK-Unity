...
namespace AdaptySDK
{
    ...
    {
        /// <summary>
        /// The UUID that you generate to associate a customer's In-App Purchase with its resulting App Store transaction. (iOS Only)
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The obfuscated account identifier (Android Only)
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="appAccountToken">The UUID for iOS App Store transactions (iOS Only)</param>
        /// <param name="obfuscatedAccountId">The obfuscated account identifier (Android Only)</param>
